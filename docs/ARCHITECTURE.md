...
| **Ingest** | `requests` · raw AF_UNIX socket HTTP · `subprocess` (docker CLI) · optional TextFSM auto-detect via `ntc-templates` (`pip install netlog-ai[parse]`, see [TFSM_AUTO_PARSER.md](TFSM_AUTO_PARSER.md)) |
